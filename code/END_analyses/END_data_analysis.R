...
# computed from the original END analytic dataset. This object and the
# precomputed benchmarking summaries are not included in the Supplementary
# Materials because the END data are subject to a confidentiality/data use
# agreement.
...
# Load the precomputed benchmarking summaries generated by utils/END_senspar_rst.R.
